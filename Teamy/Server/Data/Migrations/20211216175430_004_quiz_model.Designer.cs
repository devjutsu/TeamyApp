...
namespace Teamy.Server.Data.Migrations
{
    ...
    [Migration("20211216175430_004_quiz_model")]
    partial class _004_quiz_model
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "529912fa-31a0-423d-8e8a-ced551d5c0a3",
                            ConcurrencyStamp = "31b23ac1-f9dd-4c62-aa25-e869e73b72c3",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "3e136133-b77b-48be-b6ec-ec3472b9b58d",
                            ConcurrencyStamp = "9a619b2d-b636-4c43-b179-1e1c1d65d374",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.QCode", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.Quiz", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.QuizAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.QuizChoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.QuizCompletion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.QuizQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.QCode", b =>
                {
                    b.HasOne("Teamy.Server.Models.Quiz.Quiz", "Quiz")
                        .WithMany()
            ...
            modelBuilder.Entity("Teamy.Server.Models.Quiz.QuizAnswer", b =>
                {
                    b.HasOne("Teamy.Server.Models.Quiz.QuizQuestion", "Question")
                        .WithMany("Answers")
